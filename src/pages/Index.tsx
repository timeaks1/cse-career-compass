...
import { ArrowRight, Code2, Users, Trophy, BookOpen, ExternalLink, LogOut } from "lucide-react";
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up">
              {isAuthenticated ? (
                ...
                <>
                  <Button asChild size="lg" className="bg-gradient-primary hover:glow-primary transition-all duration-300">
                    <Link to="/auth">
                      Sign In to Share <ArrowRight className="ml-2 h-5 w-5" />
                    </Link>
                  </Button>
                  <Button asChild variant="outline" size="lg" className="glass-card hover:glow-accent transition-all duration-300">
                    <Link to="/view-experiences">
      ...
      <footer className="border-t border-border/50 py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-2xl font-bold gradient-text mb-4">Placements IITR</h3>
              <p className="text-muted-foreground">
                Empowering IITR students with real experiences and practical guidance for internships and placements.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-border/50 mt-8 pt-8 text-center text-muted-foreground">
            <p>&copy; 2025 Placements IITR. Built with ❤️ for students, by students.</p>
          </div>
        </div>
      </footer>
    </div>
